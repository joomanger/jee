...
public class CardValidatorServiceLocator extends org.apache.axis.client.Service implements com.isd.CardValidatorService {
    ...
    private java.lang.String CardValidatorPort_address = "http://localhost:8080/JEE14_SOAP-0.0.1-SNAPSHOT/CardValidatorService";
    ...
    public com.isd.Validator getCardValidatorPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.isd.CardValidatorServiceSoapBindingStub _stub = new com.isd.CardValidatorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.isd.Validator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.isd.CardValidatorServiceSoapBindingStub _stub = new com.isd.CardValidatorServiceSoapBindingStub(new java.net.URL(CardValidatorPort_address), this);
                _stub.setPortName(getCardValidatorPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://isd.com/", "CardValidatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://isd.com/", "CardValidatorPort"));
        }
